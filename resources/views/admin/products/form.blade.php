        ...
        >
            <div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <textarea name="description" id="description" cols="72"
                                  rows="7">@isset($product){{ $product->description }}@endisset</textarea><br>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <textarea name="lt_description" id="lt_description" cols="72"
                                  rows="7">@isset($product){{ $product->lt_description }}@endisset</textarea><br>
